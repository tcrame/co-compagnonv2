...
const _voie_arquebusier_voie_de_la_precision = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      ...
      type: 'A',
      description: 'L\'arquebusier utilise une action d\'attaque pour trouver le point faible de son adversaire et le viser. Au prochain round*, il réalise ses attaques à distance sur cette cible contre une DEF de [10 + AGI de la cible] et il peut ignorer sa résistance aux DM ou sa réduction des DM (sauf si cette dernière est acquise parce que la cible est immatérielle : ombre, fantôme, etc.).\n\n*Si l\'arquebusier utilise la capacité Combat de masse pour son action d\'attaque en début de round, alors la capacité s\'applique seulement aux tirs du round en cours.',
    ),
    CapaciteCatalogue(
      rang: 3,
      nom: 'Tir précis',
...
const _voie_barbare_voie_du_primitif = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      ...
      type: 'G',
      description: 'Le barbare devient capable de résister à la magie. Lorsqu\'il est la cible d\'un sort, une fois par round, il peut faire un test d\'attaque magique* opposé à celui du sort (si le sort n\'en demande pas, faites-en tout de même un à cette occasion). En cas de réussite, il n\'en subit pas les effets.\n\n> *Si le personnage est un profil hybride et qu\'il est capable de faire de la magie (il possède au moins une capacité de sort), il subit un dé malus sur ce test opposé. Avoir cédé à la magie le rend moins apte à y résister.',
    ),
    CapaciteCatalogue(
      rang: 5,
...
const _voie_chevalier_voie_de_la_noblesse = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      ...
      description: 'Le chevalier ajoute son rang + 2 aux tests réalisés pour donner des ordres ou intimider. De plus, le noble chevalier reçoit la formation nécessaire au port de l\'armure de plaque complète (DEF +7). Désormais, il peut utiliser toutes les capacités des voies de chevalier en portant cette armure.\n\n> Pour un profil hybride de combattant, cette capacité permet d\'augmenter le niveau d\'armure d\'un cran pour toutes les autres voies de combattant : jusqu\'à l\'armure de plaque pour les voies de guerrier et jusqu\'à la chemise de mailles pour les voies de barbare.',
    ),
    CapaciteCatalogue(
      rang: 4,
...
const _voie_ensorceleur_voie_de_l_envouteur = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      ...
      nom: 'Confusion',
      type: 'A',
      description: 'En réussissant un test opposé d\'attaque magique contre sa cible (portée 20 m), l\'ensorceleur désoriente sa victime pendant CHA rounds. Au tour de la victime, celui qui l\'incarne\n\n> lance 1d6 : sur 1-3 la victime n\'agit pas, sur 4-6 elle attaque la créature la plus proche (au hasard). À la fin de son tour, elle peut mettre fin au sort prématurément en réussissant un test de VOL difficulté [12 + CHA de l\'ensorceleur].',
    ),
    CapaciteCatalogue(
      rang: 4,
      nom: 'Amitié',
...
const _voie_ensorceleur_voie_de_la_divination = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      ...
      nom: 'Clairvoyance',
      type: 'A',
      description: 'L\'ensorceleur peut voir et entendre à distance ce qui se passe dans un lieu qu\'il connaît (pas de limite de portée) ou juste derrière une porte qu\'il touche pendant CHA rounds (action limitée à chaque round). Les créatures présentes ont droit à un test de PER difficulté [12 + CHA\n\n> de l\'ensorceleur] : en cas de réussite, elles se sentent observées.',
    ),
    CapaciteCatalogue(
      rang: 4,
      nom: 'Perception héroïque',
...
const _voie_forgesort_voie_du_golem = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      rang: 2,
      nom: 'Golem',
      description: 'Le golem est une créature humanoïde fabriquée par le forgesort pour lui servir de serviteur et de garde du corps. Il comprend des ordres simples, comme suivre, attaquer, monter la garde, mais il est incapable d\'actions complexes ou nécessitant une motricité fine (comme de la couture par exemple!).\n\n> GOLEM CRÉATURE NON VIVANTE | AGI -1 | CON +10 | FOR +1 | PER -3 | | CHA -4 | INT -3 | VOL +4 | (S) Défense [10 + rang dans la voie] (V) Points de vigueur [niv. du forgesort × 5] (I) Initiative [Init. du forgesort] Attaque [attaque magique du forgesort] · DM 1d4°+1',
    ),
    CapaciteCatalogue(
      rang: 3,
      nom: 'Protecteur',
...
const _voie_guerrier_voie_de_la_resistance = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      rang: 3,
      nom: 'Armure lourde',
      description: 'Au choix le guerrier gagne +1 en DEF ou il apprend à porter l\'armure de plaque (DEF +6) et désormais, il peut utiliser toutes les capacités de guerrier avec cette armure.\n\n> Dans le cas d\'un profil hybride, le personnage apprend à utiliser une armure d\'une catégorie au-dessus de celles autorisées par son profil principal. Par exemple, un barbare qui choisit cette capacité peut désormais entrer en rage en portant une chemise de mailles.',
    ),
    CapaciteCatalogue(
      rang: 4,
      nom: 'Constitution héroïque',
...
const _voie_rodeur_voie_du_compagnon_animal = VoieCatalogue(
  ...
  capacites: [
    CapaciteCatalogue(
      rang: 1,
      nom: 'Le loup',
      description: 'Le rôdeur obtient un loup pour compagnon animal. En combat, le loup attaque en même temps que le rôdeur. Le loup comprend des ordres simples (garde, reste, apporte, attaque, etc.).\n\n**LOUP** — Créature vivante  \n| AGI +1 | CON +1* | FOR +2 | PER +2* | CHA -2 | INT -3 | VOL +2 |  \nDéfense : [12 + rang dans la voie]  \nPV : [niveau du rôdeur × 4]  \nInitiative : [Init. du rôdeur]  \nAttaque au contact : [attaque magique du rôdeur] DM 1d4+2  \n*Le loup obtient un dé bonus sur ses tests.',
    ),
    CapaciteCatalogue(
      rang: 2,
    ...
    CapaciteCatalogue(
      rang: 4,
      nom: 'Loup alpha',
      description: 'Le loup du rôdeur devient un spécimen particulièrement puissant.\n\n**MÂLE ALPHA**  \n| CON +3* | FOR +5 |  \nDéfense : 18  \nPV : [Niveau × 5]  \nDM : 1d4°+5',
    ),
    CapaciteCatalogue(
      rang: 5,
...
const _voie_sorcier_voie_du_demon = VoieCatalogue(
  ...
  capacites: [
    ...
    CapaciteCatalogue(
      ...
      nom: 'Aspect du démon',
      type: 'A',
      description: 'Le sorcier prend l\'apparence d\'un démon ailé pendant INT minutes. Il gagne un dé bonus en attaque au contact et +5 en DEF et à tous les tests physiques (FOR, AGI, CON), mais il ne peut pas utiliser d\'arme (ni les arts martiaux). Il peut faire deux attaques de griffes à [1d4°+INT] DM à chaque tour, en action limitée (une seule en action d\'attaque) et il peut voler de 10 m par action de mouvement.\n\n> Note : Ne se cumule pas avec la Beauté de la succube.',
    ),
    CapaciteCatalogue(
      rang: 5,
      nom: 'Invocation d\'un démon',
      type: 'L',
      description: 'En sacrifiant 1d4° PV, le sorcier invoque un démon à son service pour INT minutes. Ce démon possède l\'apparence d\'un humanoïde musclé d\'environ 2,30 m doté d\'une épée et d\'ailes de chauve-souris. Le démon divise par deux tous les DM non magiques subis, les sorts et les armes magiques lui infligent des DM normaux. Il est capable de voler à une vitesse équivalente à un déplacement normal. Lorsque le sorcier atteint le niveau 15, le démon devient capable d\'attaquer deux fois à son tour, au prix d\'une action limitée.\n\n> DÉMON | AGI +2 | CON +4* | FOR +5* | PER +2 | | CHA +0 | INT +2 | VOL +4 | (S) Défense 18 (V) Points de vigueur [niveau du sorcier × 5] (I) Initiative [Init. du sorcier] Attaque au contact [attaque magique du sorcier] · DM 2d4°+5',
    ),
  ],
);
...
// ── Map profil → liste de voies ──────────────────────────────────────────────

const Map<String, List<VoieCatalogue>> kVoiesParProfil = {
  'Arquebusier': [
