...
class AuthService {
  ...
  // 💡 FIX DESIGN : On rend l'instance nullable et on ne l'initialise PAS sur le Web
  // pour empêcher le package de charger ses scripts JS de chiffrement natifs défectueux.
